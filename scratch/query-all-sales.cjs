...
async function main() {
  ...
  try {
    ...
    console.log(`TOTAL_ALL_TIME_SALES: ${allSales.length}`);
    for (const sale of allSales) {
      console.log(`${sale.created_at} | Product: ${sale.product_name} | Qty: ${sale.qty} | Price: ${sale.sell_price} | Paid: ${sale.paid_amount} | Due: ${sale.due_amount}`);
    }
