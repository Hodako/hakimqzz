...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const systemPrompt = `You are an expert AI business advisor and financial analyst for Dream IT POS & Billing Software. You have access to live real-time business statistics.
