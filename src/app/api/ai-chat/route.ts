...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const systemPrompt = `You are an expert AI business advisor and financial analyst for a retail fashion management platform called Dream Fashion (HakimQzz). You have access to live real-time business statistics.
