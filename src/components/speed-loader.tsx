/** Quiet, Material-style circular spinner loader to minimize visual noise. */
export function SpeedLoader({ fullScreen = true }: { fullScreen?: boolean }) {
  ...
  return (
    <div className="fixed inset-0 bg-background/70 backdrop-blur-xs z-50 flex items-center justify-center">
      <div className="bg-card border border-border p-5 rounded-2xl shadow-xl flex flex-col items-center gap-3">
